...
- **Netpractice** – networking fundamentals (enumeration & scanning) ([Netpractice](https://github.com/Loreenbh/netpractice))
- **Born2beroot** – Linux system administration and secure configuration → user management, sudo policies, and system hardening ([Born2beroot](https://github.com/Loreenbh/born2beroot))
